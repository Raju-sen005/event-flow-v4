...
export const CreateTicketModal: React.FC<CreateTicketModalProps> = ({
  ...
  const categories = [
    ...
    },
    {
      value: "payment_issue",
      label: "Payment Issue",
      description: "Payment delays, issues, or inquiries",
    },
    {
      value: "bid_related",
      label: "Bid Related",
      description: "Questions about bids or proposals",
    },
    {
      value: "event_related",
      label: "Event Related",
      description: "Event details or coordination",
    },
    {
      value: "invoice_issue",
      label: "Invoice Issue",
      description: "Invoice generation or payment",
    },
    {
      value: "attendance_issue",
      label: "Attendance Issue",
      description: "Mark in/out or attendance problems",
    },
    {
  ...
  const handleSubmit = async () => {
    ...
    await axios.post("https://gogatherhub.com:5000/api/support/tickets", {
      vendorId,
      ...
      relatedReference: formData.relatedReference
    });
      ...
      >
        ...
        <div className="bg-gradient-to-r from-[#075056] to-[#075056]/90 p-4 md:p-6 text-white flex-shrink-0">
          ...
          <div className="flex items-center gap-2">
            <div
              className={`flex-1 h-1 rounded ${step >= 1 ? "bg-white" : "bg-white/20"}`}
            />
            <div
              className={`flex-1 h-1 rounded ${step >= 2 ? "bg-white" : "bg-white/20"}`}
            />
          </div>
        </div>
                  ...
                  {categories.map((cat) => (
                    <div
                      ...
                      onClick={() =>
                        setFormData({
                          ...formData,
                          category: cat.value as TicketCategory,
                        })
                      }
              ...
              <div>
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
                  {priorities.map((priority) => (
                    ...
                    >
                      <div
                        className={`inline-block px-2 py-1 ${priority.color} text-xs font-semibold rounded mb-1`}
                      >
                        {priority.label}
                      </div>
            ...
            >
              ...
              {/* <div>
                ...
                <p className="text-sm text-gray-600 mb-3">
                  Link this ticket to an event, bid, invoice, or payment
                </p>
                <select
                ...
                {formData.relatedType && (
                  <input
                    ...
                    onChange={(e) =>
                      setFormData({
                        ...formData,
                        relatedReference: e.target.value,
                      })
                    }
