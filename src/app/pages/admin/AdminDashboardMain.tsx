...
type AdminSection = 'vendors' | 'requirements' | 'support';
...
export const AdminDashboardMain: React.FC = () => {
  ...
  const supportTickets: SupportTicket[] = [
    ...
    {
      id: 'TKT-1238',
      subject: 'Question about commission structure',
  ...
  return (
    <div className="min-h-screen bg-gray-50">
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-4">
              <div className="text-right">
                <p className="text-sm font-semibold text-[#16232A]">Admin User</p>
      ...
      <div className="max-w-7xl mx-auto px-6 py-8">
        {/* Page Header */}
        <div className="mb-8">
          <h1 className="text-3xl font-bold text-[#16232A] mb-2">Admin Dashboard</h1>
        ...
        <div className="bg-white rounded-xl border border-gray-200 mb-6">
          ...
          <div className="p-6">
            ...
            {activeSection === 'requirements' && (
              ...
              >
                <div className="mb-6">
                  <h2 className="text-xl font-bold text-[#16232A] mb-4">Monitoring & Compliance</h2>
                  ...
                  <div className="border border-gray-200 rounded-lg overflow-hidden">
                    <table className="w-full">
                      ...
                      <tbody className="bg-white divide-y divide-gray-200">
                        ...
                        <tr className="hover:bg-gray-50 transition-colors">
                          <td className="px-6 py-4 whitespace-nowrap text-sm font-medium text-[#16232A]">REQ-1235</td>
                          <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">Corporate Event</td>
                          <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-600">Tech Solutions Ltd</td>
                          <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-600">Bangalore, KA</td>
                          <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-600">2025-02-20</td>
                          <td className="px-6 py-4 whitespace-nowrap text-sm font-semibold text-gray-900">₹2,50,000</td>
                          <td className="px-6 py-4 whitespace-nowrap">
                        ...
                        <tr className="hover:bg-gray-50 transition-colors">
                          <td className="px-6 py-4 whitespace-nowrap text-sm font-medium text-[#16232A]">REQ-1236</td>
                          <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">Birthday Party</td>
                          <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-600">Ravi Mehta</td>
                          <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-600">Delhi, DL</td>
                          <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-600">2025-02-10</td>
                          <td className="px-6 py-4 whitespace-nowrap text-sm font-semibold text-gray-900">₹75,000</td>
                          <td className="px-6 py-4 whitespace-nowrap">
                ...
                {monitoringTab === 'bids' && (
                  <div className="border border-gray-200 rounded-lg overflow-hidden">
                    <table className="w-full">
                      <thead className="bg-gray-50 border-b border-gray-200">
                        <tr>
                          <th className="px-6 py-3 text-left text-xs font-semibold text-gray-600 uppercase tracking-wide">Bid ID</th>
                          <th className="px-6 py-3 text-left text-xs font-semibold text-gray-600 uppercase tracking-wide">Requirement</th>
                          <th className="px-6 py-3 text-left text-xs font-semibold text-gray-600 uppercase tracking-wide">Vendor</th>
                          <th className="px-6 py-3 text-left text-xs font-semibold text-gray-600 uppercase tracking-wide">Bid Amount</th>
                      ...
                      <tbody className="bg-white divide-y divide-gray-200">
                        <tr className="hover:bg-gray-50 transition-colors">
                          <td className="px-6 py-4 whitespace-nowrap text-sm font-medium text-[#16232A]">BID-5678</td>
                          <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">REQ-1234 (Wedding)</td>
                          <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-600">Elegance Photography</td>
                          <td className="px-6 py-4 whitespace-nowrap text-sm font-semibold text-gray-900">₹1,50,000</td>
                          <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-600">2025-01-05</td>
                          <td className="px-6 py-4 whitespace-nowrap">
                        ...
                        <tr className="hover:bg-gray-50 transition-colors">
                          <td className="px-6 py-4 whitespace-nowrap text-sm font-medium text-[#16232A]">BID-5679</td>
                          <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">REQ-1235 (Corporate Event)</td>
                          <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-600">Royal Caterers</td>
                          <td className="px-6 py-4 whitespace-nowrap text-sm font-semibold text-gray-900">₹2,00,000</td>
                          <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-600">2025-01-04</td>
                          <td className="px-6 py-4 whitespace-nowrap">
                            <span className="px-2 py-1 text-xs font-medium rounded-full bg-yellow-100 text-yellow-700">Pending</span>
                          </td>
                          <td className="px-6 py-4 whitespace-nowrap">
                        ...
                        <tr className="hover:bg-gray-50 transition-colors">
                          <td className="px-6 py-4 whitespace-nowrap text-sm font-medium text-[#16232A]">BID-5680</td>
                          <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">REQ-1234 (Wedding)</td>
                          <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-600">Floral Dreams Decor</td>
                          <td className="px-6 py-4 whitespace-nowrap text-sm font-semibold text-gray-900">₹85,000</td>
                          <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-600">2025-01-05</td>
                          <td className="px-6 py-4 whitespace-nowrap">
                ...
                {monitoringTab === 'agreements' && (
                  <div className="border border-gray-200 rounded-lg overflow-hidden">
                    <table className="w-full">
                      <thead className="bg-gray-50 border-b border-gray-200">
                        <tr>
                          <th className="px-6 py-3 text-left text-xs font-semibold text-gray-600 uppercase tracking-wide">Agreement ID</th>
                          <th className="px-6 py-3 text-left text-xs font-semibold text-gray-600 uppercase tracking-wide">Event</th>
                          <th className="px-6 py-3 text-left text-xs font-semibold text-gray-600 uppercase tracking-wide">Customer</th>
                          <th className="px-6 py-3 text-left text-xs font-semibold text-gray-600 uppercase tracking-wide">Vendor</th>
                          <th className="px-6 py-3 text-left text-xs font-semibold text-gray-600 uppercase tracking-wide">Amount</th>
                          <th className="px-6 py-3 text-left text-xs font-semibold text-gray-600 uppercase tracking-wide">Signed Date</th>
                          <th className="px-6 py-3 text-left text-xs font-semibold text-gray-600 uppercase tracking-wide">Status</th>
                          <th className="px-6 py-3 text-left text-xs font-semibold text-gray-600 uppercase tracking-wide">Actions</th>
                        </tr>
                      </thead>
                      <tbody className="bg-white divide-y divide-gray-200">
                        <tr className="hover:bg-gray-50 transition-colors">
                          <td className="px-6 py-4 whitespace-nowrap text-sm font-medium text-[#16232A]">AGR-9012</td>
                          <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">Wedding - REQ-1234</td>
                          <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-600">Sneha Kapoor</td>
                          <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-600">Elegance Photography</td>
                          <td className="px-6 py-4 whitespace-nowrap text-sm font-semibold text-gray-900">₹1,50,000</td>
                          <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-600">2025-01-06</td>
                          <td className="px-6 py-4 whitespace-nowrap">
                        ...
                        <tr className="hover:bg-gray-50 transition-colors">
                          <td className="px-6 py-4 whitespace-nowrap text-sm font-medium text-[#16232A]">AGR-9013</td>
                          <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">Corporate - REQ-1235</td>
                          <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-600">Tech Solutions Ltd</td>
                          <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-600">Royal Caterers</td>
                          <td className="px-6 py-4 whitespace-nowrap text-sm font-semibold text-gray-900">₹2,00,000</td>
                          <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-600">2025-01-03</td>
                          <td className="px-6 py-4 whitespace-nowrap">
                            <span className="px-2 py-1 text-xs font-medium rounded-full bg-blue-100 text-blue-700">Completed</span>
                          </td>
                          <td className="px-6 py-4 whitespace-nowrap">
                            <Button variant="ghost" size="sm" className="text-[#FF5B04] hover:text-[#FF5B04]/80">
                              <Eye className="h-4 w-4 mr-1" />
    ...
    <div className="fixed inset-0 bg-black/60 backdrop-blur-sm z-50 flex items-center justify-center p-6">
      ...
      >
        <div className="sticky top-0 bg-white border-b border-gray-200 p-6 flex items-center justify-between">
          <div>
            <h3 className="text-xl font-bold text-[#16232A] mb-1">{ticket.subject}</h3>
        ...
        <div className="p-6 space-y-6">
          ...
          <div className="grid md:grid-cols-2 gap-6 pb-6 border-b border-gray-200">
            <div>
              ...
              <p className="text-base font-semibold text-[#16232A] mt-1">{ticket.userName}</p>
            ...
            <div>
              ...
              <p className="text-base font-semibold text-[#16232A] mt-1 flex items-center gap-2">
                ...
                {new Date(ticket.lastUpdated).toLocaleDateString('en-IN', { 
                  year: 'numeric', 
                  month: 'long', 
                  day: 'numeric' 
                })}
          ...
          {/* Conversation Thread */}
          <div>
            <h4 className="text-sm font-bold text-[#16232A] mb-4 flex items-center gap-2">
            ...
            <div className="space-y-4">
              <div className="bg-gray-50 rounded-lg p-4">
                <div className="flex items-start justify-between mb-2">
                  <div>
                    <p className="text-sm font-semibold text-[#16232A]">{ticket.userName}</p>
                    <p className="text-xs text-gray-500">{new Date(ticket.createdDate).toLocaleString('en-IN')}</p>
                  </div>
                  <span className="text-xs px-2 py-1 bg-blue-100 text-blue-700 rounded font-medium">User</span>
                </div>
                <p className="text-sm text-gray-700 leading-relaxed">
                  I completed a wedding photography event on January 3rd for the customer Sneha Kapoor (Event ID: EVT-1234). 
                  The payment of ₹1,50,000 was supposed to be processed within 3-5 business days after event completion, 
                  but it has been over 5 days now and I haven't received the payment yet. Could you please check the status?
                </p>
              </div>
              ...
              <div className="bg-blue-50 rounded-lg p-4 ml-8">
                <div className="flex items-start justify-between mb-2">
                  <div>
                    <p className="text-sm font-semibold text-[#16232A]">Support Team</p>
                    <p className="text-xs text-gray-500">{new Date(ticket.lastUpdated).toLocaleString('en-IN')}</p>
                  </div>
                  <span className="text-xs px-2 py-1 bg-[#FF5B04]/10 text-[#FF5B04] rounded font-medium">Admin</span>
                </div>
                <p className="text-sm text-gray-700 leading-relaxed">
                  Thank you for reaching out. We've reviewed your payment request and confirmed that the event was successfully 
                  completed. The payment is currently being processed by our finance team. You should receive it within the next 
                  24-48 hours. We apologize for the delay and appreciate your patience.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="pt-6 border-t border-gray-200">
            <label className="block text-sm font-semibold text-[#16232A] mb-3">Update Status</label>
