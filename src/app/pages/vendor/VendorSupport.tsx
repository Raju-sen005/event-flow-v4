...
export const VendorSupport: React.FC = () => {
  ...
  //     description:
  //       "I have completed the event and submitted the invoice 10 days ago, but payment has not been received yet.",
  //     priority: "high",
  //     status: "in_progress",
  //     relatedType: "invoice",
  //     relatedId: "inv-001",
  ...
  //         senderRole: "admin",
  //         message:
  //           "Thank you for reaching out. We are reviewing your invoice and will process the payment within 2 business days.",
  ...
  //     description:
  //       "Getting an error when trying to upload images to my portfolio section.",
  //     priority: "medium",
  //     status: "resolved",
  //     messages: [
  //       {
                ...
                <div className="flex items-start justify-between mb-4">
                  <div className="flex-1">
                    <div className="flex items-center gap-2 mb-2">
                      ...
                      <span
                        className={`px-2 py-1 ${statusConfig.color} text-xs font-medium rounded flex items-center gap-1`}
                      >
