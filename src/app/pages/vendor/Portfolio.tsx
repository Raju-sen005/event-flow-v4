...
export const Portfolio: React.FC = () => {
  ...
  const getMedia = (item: PortfolioItem) => {
          ...
          portfolioItems.map((p) =>
            p.id === selectedItem.id
              ? {
                  ...p,
                  ...formData,
                  PortfolioMedia: uploadedMedia.map((media) => ({
                    ...media,
                    id: media.url, // Use URL as temporary ID for new media
                  })),
                }
              : p,
          ),
              ...
              {modalMode === "view" ? (
                <>
                  ...
                  <div>
                    ...
                    <p
                      className={`mt-1 inline-flex px-2 py-1 rounded text-sm font-medium ${
