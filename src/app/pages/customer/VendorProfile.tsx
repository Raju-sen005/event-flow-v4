  ...
  const reviews = [
    {
      ...
      event: "Wedding",
      comment:
        "Absolutely phenomenal! Elite Photography captured our special day perfectly. Every shot was artistic and emotional. Highly recommended!",
    },
    {
      id: 2,
      author: "Michael Chen",
      ...
      comment:
        "Professional, punctual, and creative. They made our corporate gala look amazing. Will definitely hire again!",
    },
    {
      id: 3,
      ...
      comment:
        "Great experience overall. Beautiful photos and excellent communication throughout the process.",
    },
  ];
          ...
          {activeTab === "overview" && (
            <div className="space-y-6">
              <div>
                ...
                <p className="text-[#16232A]/70 leading-relaxed">
                  {vendor.description}
                </p>
              </div>

              <div>
                <h2 className="text-xl font-bold text-[#16232A] mb-3">
                  Services Offered
                </h2>
