...
import { Eye, EyeOff, AlertCircle, Mail, Lock, Crown } from 'lucide-react';
  ...
  return (
    ...
    >
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-3">
        ...
        <Button
          type="submit"
          className="w-full h-12 bg-gradient-to-r from-orange-500 to-orange-600 hover:from-orange-600 hover:to-orange-700 text-white rounded-xl mt-6"
          disabled={isLoading}
        >
          {isLoading ? (
            <>
        ...
        <div className="pt-4 text-center">
          <p className="text-xs text-gray-500">
            Highest level access. For system administrators only.
          </p>
        </div>
      </form>
    </AuthLayout>
