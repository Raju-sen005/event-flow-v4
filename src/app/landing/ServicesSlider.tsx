...
const services = [
  {
    ...
    description:
      "Browse thousands of verified vendors for photography, catering, decor & more.",
    color: "#FF5B04",
    bg: "#FF5B04/10",
  ...
  },
  {
    ...
    description:
      "Hire certified event planners to manage your entire event end-to-end.",
    color: "#075056",
    bg: "#075056/10",
  ...
  },
  {
    ...
    description:
      "Rent wedding wear, decor, lighting & accessories at affordable prices.",
    color: "#FF5B04",
    bg: "#FF5B04/10",
  ...
  },
  {
    ...
    description:
      "Manage invitations, RSVPs, seating and QR-based event entry seamlessly.",
    color: "#075056",
    bg: "#075056/10",
  ...
  },
  {
    ...
    description:
      "Create, sign and manage vendor contracts digitally with full legal protection.",
    color: "#FF5B04",
    bg: "#FF5B04/10",
  ...
  },
  {
    ...
    description:
      "Pay vendors in milestones with full deposit protection and refund policies.",
    color: "#075056",
    bg: "#075056/10",
  ...
  },
  {
    ...
    description:
      "Design beautiful digital invitations and send them to your guest list instantly.",
    color: "#FF5B04",
    bg: "#FF5B04/10",
  ...
  },
  {
    ...
    description:
      "Plan and track every task and milestone in your event execution timeline.",
    color: "#075056",
    bg: "#075056/10",
          ...
          <div className="flex items-end justify-between mb-10">
            ...
            >
              ...
              <h2 className="text-3xl lg:text-4xl font-bold text-[#16232A]">
                From Idea to <span className="text-[#FF5B04]">Celebration</span>{" "}
                in Real Steps
              </h2>
            </motion.div>
          ...
          >
            {services.map((service, i) => (
              ...
              >
                ...
                <h3 className="font-bold text-[#16232A] mb-2">
                  {service.title}
                </h3>
