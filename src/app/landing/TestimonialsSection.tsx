...
const testimonials = [
  {
    ...
    quote: 'EventFlow made our dream wedding a reality! We found the perfect photographer, decorator, and caterer all in one place. The bidding system saved us nearly ₹2 lakhs compared to our original budget. The milestone payment feature gave us complete peace of mind.',
    verified: true,
    saved: '₹2L saved',
  },
  {
    ...
    quote: 'As an event manager for a Fortune 500 company, I\'ve tried many platforms. EventFlow is hands down the best. The vendor verification process is thorough, the digital agreements saved us weeks of paperwork, and the QR-based attendance tracking was flawless.',
    verified: true,
    saved: '40% time saved',
  },
  {
