...
export const HeroSection: React.FC = () => {
  ...
  const handleCategoryClick = (cat: any) => {
    ...
    if (!isLoggedIn) {
      ...
      navigate(`/customer/global-vendors?category=${cat.name}`);
    }
  };

  const handleVendorClick = (cat: any) => {
    const isLoggedIn = !!localStorage.getItem("token");
  ...
  const handleStartPlanning = () => {
    ...
    // if (!isLoggedIn) {
    setPlanningOpen(true); // ✅ modal open
    // } else {
    // navigate(""); // ya planning page
    // }
  };
          ...
          <div className="max-w-[1280px] mx-auto px-6 lg:px-8 py-20 w-full">
            <div className="grid lg:grid-cols-2 gap-16 items-center">
              ...
              <div className="space-y-8">
                ...
                >
                  Discover vendors, hire planners, rent essentials, manage
                  guests, and track payments — all in one powerful platform.
                </motion.p>
